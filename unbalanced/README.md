...
The following image displays the input discrete measures (from `dataset_letters/`), where each distribution has an **unequal total mass**:

![Input: dataset_letters](figures/MAM_dataset.png)
